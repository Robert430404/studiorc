    ...
    <div class="introduction">
        <div class="row fluid">
            <div class="columns large-12 large-offset-0 medium-12 medium-offset-0 small-12 small-offset-0">
                ...
                <h3 class="aligncenter sub-heading">ROBERT COX - LAS VEGAS, NV</h3>
                <ul class="social menu horizontal">
                    ...
                    <li class="icon"><a href="https://twitter.com/robert430404" target="_blank"><i class="fa fa-twitter"></i></a></li>
